...
class VIN {
	...
	*/
	public function manufacturer() : string {
		...
		$brandx = strtoupper(substr($this->VIN,0,3));  # extract first 3 letters that represent Country + WMI identifier
			/*
			...
			*/				
				...
				if(strpos($brandx,'JHA') !==false)  { $brand='Hino'; }
				if(strpos($brandx,'JHE') !==false)  { $brand='Hino'; }

				if(strpos($brandx,'JHF') !==false)  { $brand='Honda'; }
				if(strpos($brandx,'JHG') !==false)  { $brand='Honda'; }
				if(strpos($brandx,'JHL') !==false)  { $brand='Honda'; }
				if(strpos($brandx,'JHN') !==false)  { $brand='Honda'; }
				if(strpos($brandx,'JHZ') !==false)  { $brand='Honda'; }
				...
				if($brandx == 'VF9')  { $brand='Bugatti'; }
				if($brandx == '795')  { $brand='Bugatti'; }
				...
				if(strpos($brandx,'XL9') !==false)  { $brand='Spyker'; }
				if(strpos($brandx,'363') !==false)  { $brand='Spyker'; }
				...
				if($brandx == 'YT9')  { $brand='Koenigsegg'; }
				if($brandx == '034')  { $brand='Carvia'; }
